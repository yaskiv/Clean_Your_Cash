package yaskiv.clean_cache_for_all.app.fragment;
...
import yaskiv.clean_cache_for_all.app.activity.SettingsActivity;
import yaskiv.clean_cache_for_all.app.adapter.AppsListAdapter;
import yaskiv.clean_cache_for_all.app.model.AppsListItem;
import yaskiv.clean_cache_for_all.app.model.CleanerService;
import yaskiv.clean_cache_for_all.app.model.Singleton;
import yaskiv.clean_cache_for_all.app.widget.DividerDecoration;
import yaskiv.clean_cache_for_all.app.widget.RecyclerView;

import static yaskiv.clean_cache_for_all.app.model.Singleton.mAppsListAdapter;
import static yaskiv.clean_cache_for_all.app.model.Singleton.mCleanerService;
...
private  static   int count=0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("dsd", String.valueOf(mServiceConnection));


        getActivity().getApplication().bindService(new Intent(getActivity(), CleanerService.class),
                mServiceConnection, Context.BIND_AUTO_CREATE);
            count++;
    Log.d("Singleton", "onCreate: ");
}else
{

    mAppsListAdapter.setItems(getActivity(), Singleton.getmItems(), getSortBy(), mSearchQuery);
}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            rootView = inflater.inflate(R.layout.cleaner_fragment, container, false);
        ...
        switch (item.getItemId()) {
            case R.id.action_clean:
                if (mCleanerService != null && !mCleanerService.isScanning() &&
                    ...
                    cleanCache();
                    Date date = new Date();
                    Singleton.setmLastDateOfClean(sdf.format(date));
                    mCleanerService.scanCache();
                }
                return true;
